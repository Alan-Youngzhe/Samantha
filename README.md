<p align="center">
  <img src="docs/hero.png" alt="Samantha" width="100%" />
</p>
...
* 六个 Agent 工具：`search_nearby_shops` / `search_store_reviews` / `get_personal_context` / `get_weather` / `get_route` / `get_place_detail`

* Samantha 主动调用天气和路线——下雨提醒带伞，推荐店铺时告诉你走过去要多久
